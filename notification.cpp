...
void notification::Alerte_Ajout(QString nom,int i)
{
    ...
    notifyIcon->setIcon(QIcon("C:/Users/Admin/Desktop/Atelier_Connexion/icon.jpg"));
       ...
       notifyIcon->showMessage("Erreur!","On peut pas ajouter cet Emplacement",QSystemTrayIcon::Warning,1500);
       }
       else if (i==2)
       {
         notifyIcon->showMessage("Emplacement","Un nouveau Emplacement nommé "+nom+" a été ajouté",QSystemTrayIcon::Information,1500);
       }
...
void notification::Alerte_Modifier(QString nom, int i)
{
    ...
    notifyIcon->setIcon(QIcon("C/Users/USER/Desktop/Atelier_Connexion/icon.jpg"));
       ...
       notifyIcon->showMessage("Erreur","On peut pas modifier cet Emplacement",QSystemTrayIcon::Warning,1500);
       }
       else if (i==2)
       {
         notifyIcon->showMessage("Emplacement","Un Emplacement nommé "+nom+" a été modifié",QSystemTrayIcon::Information,1500);
       }
...
void notification::Alerte_Supprimer(QString nom,int i)
{
   ...
   notifyIcon->setIcon(QIcon("C:/Users/Admin/Desktop/Atelier_Connexion/icon.jpg"));
       ...
       notifyIcon->showMessage("Erreur!","On ne peut pas supprimer cet Emplacement",QSystemTrayIcon::Warning,1500);
       }
       else if (i==2)
       {
         notifyIcon->showMessage("Emplacement","Un Emplacement nommé "+nom+" a été supprimé",QSystemTrayIcon::Information,1500);
       }
